...
public class sph : ModuleRules
{
    ...
    public sph(ReadOnlyTargetRules Target) : base(Target)
	{
        ...
        PublicAdditionalLibraries.Add(Path.Combine(project_root_path, custom_cuda_lib_lib, "CUDA_SPH.lib"));
